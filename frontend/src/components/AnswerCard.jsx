    ...
    const sourceList = (sources || [])
      .map(
        (s, i) =>
          ...
          (s.score ? `- **Relevance Score:** ${(s.score * 100).toFixed(1)}%\n` : "") +
          `\n> ${s.text ? s.text.replace(/\n/g, "\n> ") : "N/A"}\n`
      )
      .join("\n");

    const content = `# Axiom RAG Research Brief
...
---
*Report generated by Axiom RAG Autonomous Research Assistant.*
`;
    ...
    link.href = url;
    link.download = `axiom-research-brief-${timestamp}.md`;
